  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav" style="direction: ltr;">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#category" aria-expanded="false" aria-controls="category">
              ...
              <span class="menu-title">ادارة الفئات الدراسية</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="category">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-flex">
                  <a class="nav-link {{ Route::is('course_categories.index') ? 'active' : '' }}"
                    href="{{ route('course_categories.index') }}">عرض الفئات الدراسية</a>
                </li>
                <li class="nav-item d-flex">
                  <a class="nav-link {{ Route::is('course_categories.create') ? 'active' : '' }}"
                    href="{{ route('course_categories.create') }}">اضافة فئة جديدة</a>
                </li>
              </ul>
            </div>
          </li>

          <li class="nav-item nav-category d-flex" style="direction: rtl !important;">الكورسات</li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#courses" aria-expanded="false" aria-controls="courses">
              <i class="menu-icon mdi mdi-book-multiple"></i>
              <span class="menu-title">ادارة الكورسات</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="courses">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-flex">
                  <a class="nav-link {{ Route::is('courses.index') ? 'active' : '' }}"
                    href="{{ route('courses.index') }}">عرض الكورسات</a>
                </li>
                <li class="nav-item d-flex">
                  <a class="nav-link {{ Route::is('courses.create') ? 'active' : '' }}"
                    href="{{ route('courses.create') }}">اضافة الكورسات</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item nav-category d-flex" style="direction: rtl !important;"> الاكواد </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#codes" aria-expanded="false" aria-controls="codes">
              <i class="menu-icon mdi mdi-layers-outline"></i>
              <span class="menu-title"> ادارة الاكواد </span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="codes">
              <ul class="nav flex-column sub-menu"> 
                <li class="nav-item {{ Route::currentRouteName() == "coupons.index" ? 'active':'' }} d-flex"> <a class="nav-link" href="{{route('coupons.index')}}"> عرض جميع الاكواد </a></li>
                <li class="nav-item {{ Route::currentRouteName() == "coupons.create" ? 'active':'' }} d-flex"> <a class="nav-link" href="{{route('coupons.create')}}"> اضافة  الاكواد </a></li>
                <li class="nav-item {{ Route::currentRouteName() == "coupons.apply" ? 'active':'' }} d-flex"> <a class="nav-link" href="{{route('coupons.apply')}}"> استخدام الاكواد </a></li>
              </ul>
            </div>
          </li> 

          <li class="nav-item nav-category d-flex" style="direction: rtl !important;"> الماليات </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
              <i class="menu-icon mdi mdi-layers-outline"></i>
              <span class="menu-title"> ادارة الماليات </span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item {{ Route::currentRouteName() == "charge.index" ? 'active':'' }} d-flex"> <a class="nav-link" href="{{route('charge.index')}}"> شحن المحفظة </a></li>
                <li class="nav-item {{ Route::currentRouteName() == "transactions.index" ? 'active':'' }} d-flex"> <a class="nav-link" href="{{route('transactions.index')}}">  العمليات المالية </a></li>
              </ul>
            </div>
          </li> 
          <li class="nav-item nav-category d-flex" style="direction: rtl !important;">المستخدمين</li>
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-flex"> <a class="nav-link" href="{{route('students.index')}}"> الطلاب </a></li>
              </ul>
            </div>
          </li>
        </ul>
