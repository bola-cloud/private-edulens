...
|
*/
Route::post('/register/jet', [AuthController::class, 'register'])->name('register_jet');
Route::post('/login/jet', [AuthController::class, 'login'])->name('login_jet');

// admin dashboard (adminmiddleware)
//grades
